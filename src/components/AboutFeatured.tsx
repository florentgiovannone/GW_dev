...
export default function AboutFeatured() {
    return (
        <>
            <div className="bg-gradient-to-b from-gw-purple to-black flex flex-col justify-center items-center pt-14 min-h-220 md:min-h-15 lg:min-h-130 px-4 md:px-8 lg:px-12 relative overflow-hidden" >
                <img
                    src={BackgroundImage}
                    alt=""
